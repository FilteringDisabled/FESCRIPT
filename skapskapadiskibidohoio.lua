...
cmd.add({"scripthub","hub"},{"scripthub (hub)","Thanks to scriptblox api"},function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/FilteringDisabled/FESCRIPT/refs/heads/main/schubantiscriptmalware.lua"))()
end)
...
--@babyoutmoon4 (Creator of Remaker)
--@ltseverydayyou (Creator)
